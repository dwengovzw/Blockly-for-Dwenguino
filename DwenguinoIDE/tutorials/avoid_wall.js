...
tutorials.avoidWall = {
      ...
      steps: [
        {
          title: MSG.tutorials.avoidWall.step1Title,
          content: MSG.tutorials.avoidWall.step1Content,
        ...
        {
          title: MSG.tutorials.avoidWall.step2Title,
          content: MSG.tutorials.avoidWall.step2Content,
      ...
      {
        title: MSG.tutorials.avoidWall.step3Title,
        content: MSG.tutorials.avoidWall.step3Content,
    ...
    {
      title: MSG.tutorials.avoidWall.step4Title,
      content: MSG.tutorials.avoidWall.step4Content,
