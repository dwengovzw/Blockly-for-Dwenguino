...
tutorials.rideInSquare = {
      ...
      steps: [
        {
          title: MSG.tutorials.rideInSquare.step1Title,
          content: MSG.tutorials.rideInSquare.step1Content,
        ...
        {
          title: MSG.tutorials.rideInSquare.step2Title,
          content: MSG.tutorials.rideInSquare.step2Content,
      ...
      {
        title: MSG.tutorials.rideInSquare.step3Title,
        content: MSG.tutorials.rideInSquare.step3Content,
    ...
    {
      title: MSG.tutorials.rideInSquare.step4Title,
      content: MSG.tutorials.rideInSquare.step4Content,
      target: tutorialTargets.dwenguino,
      placement: "left",
      showCloseButton:"true",
      width: 400,
