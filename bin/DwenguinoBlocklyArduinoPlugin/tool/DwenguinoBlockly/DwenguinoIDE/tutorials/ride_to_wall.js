...
tutorials.rideToWall = {
      ...
      steps: [
        {
          title: MSG.tutorials.rideToWall.step1Title,
          content: MSG.tutorials.rideToWall.step1Content,
        ...
        {
          title: MSG.tutorials.rideToWall.step2Title,
          content: MSG.tutorials.rideToWall.step2Content,
      ...
      {
        title: MSG.tutorials.rideToWall.step3Title,
        content: MSG.tutorials.rideToWall.step3Content,
        target: tutorialTargets.simulatorScenarioSelection,
        placement: "left",
        showCloseButton:"true",
        width: 400,
        yOffset: -20,
    ...
    {
      title: MSG.tutorials.rideToWall.step4Title,
      content: MSG.tutorials.rideToWall.step4Content,
