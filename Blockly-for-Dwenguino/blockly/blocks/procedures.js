...
Blockly.Blocks['procedures_defreturn_typed_params'] = {
  ...
  init: function() {
    ...
    this.appendValueInput('RETURN')
        ...
        .appendField(new Blockly.FieldDropdown(Blockly.Arduino.TYPES), 'RETURN_TYPE')
        .appendField(Blockly.Msg.PROCEDURES_DEFRETURN_RETURN);
    this.setMutator(new Blockly.Mutator(['procedures_mutatorarg_typed_params']));
    if ((this.workspace.options.comments ||
         (this.workspace.options.parentWorkspace &&
          this.workspace.options.parentWorkspace.options.comments)) &&
  ...
  decompose: function(workspace) {
    ...
    for (var i = 0; i < this.arguments_.length; i++) {
      var paramBlock = workspace.newBlock('procedures_mutatorarg_typed_params');
      paramBlock.initSvg();
...
Blockly.Blocks['procedures_defnoreturn_typed_params'] = {
  /**
   * Block for defining a procedure with no return value.
   * @this Blockly.Block
   */
   ...
   * @this Blockly.Block
   */
  setStatements_: Blockly.Blocks['procedures_defreturn_typed_params'].setStatements_,
  /**
   * Update the display of parameters for this procedure definition block.
   ...
   * @this Blockly.Block
   */
  mutationToDom: Blockly.Blocks['procedures_defreturn_typed_params'].mutationToDom,
  /**
   * Parse XML to restore the argument inputs.
   * @param {!Element} xmlElement XML storage element.
   * @this Blockly.Block
   */
  domToMutation: Blockly.Blocks['procedures_defreturn_typed_params'].domToMutation,
  /**
   * Populate the mutator's dialog with this block's components.
   * @param {!Blockly.Workspace} workspace Mutator's workspace.
   * @return {!Blockly.Block} Root block in mutator.
   * @this Blockly.Block
   */
  decompose: Blockly.Blocks['procedures_defreturn_typed_params'].decompose,
  /**
   * Reconfigure this block based on the mutator dialog's components.
   * @param {!Blockly.Block} containerBlock Root block in mutator.
   * @this Blockly.Block
   */
  compose: Blockly.Blocks['procedures_defreturn_typed_params'].compose,
  /**
   * Return the signature of this procedure definition.
   * @return {!Array} Tuple containing three elements:
   *     - the name of the defined procedure,
   ...
   * @this Blockly.Block
   */
  getVars: Blockly.Blocks['procedures_defreturn_typed_params'].getVars,
  /**
   * Notification that a variable is renaming.
   ...
   * @this Blockly.Block
   */
  renameVar: Blockly.Blocks['procedures_defreturn_typed_params'].renameVar,
  /**
   * Add custom menu options to this block's context menu.
   * @param {!Array} options List of menu options to add to.
   * @this Blockly.Block
   */
  customContextMenu: Blockly.Blocks['procedures_defreturn_typed_params'].customContextMenu,
  callType_: "procedures_callnoreturn"
};
...
Blockly.Blocks['procedures_mutatorarg_typed_params'] = {
  /**
   * Mutator block for procedure argument.
   * @this Blockly.Block
   */
  init: function() {
    ...
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldDropdown(Blockly.Arduino.TYPES),
                     'TYPE');
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setColour(Blockly.Blocks.procedures.HUE);
