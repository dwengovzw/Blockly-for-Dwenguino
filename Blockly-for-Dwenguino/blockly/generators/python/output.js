 ...
 */
 ...
 Blockly.Python['socialrobot_rgbled'] = function(block){
   ...
   var pin_green = Blockly.Python.valueToCode(block, 'pin_green', Blockly.Python.ORDER_NONE);
   var pin_blue = Blockly.Python.valueToCode(block, 'pin_blue', Blockly.Python.ORDER_NONE);
 ...
 Blockly.Python['socialrobot_rgbled_off'] = function(block) {
   var pin_red = Blockly.Python.valueToCode(block, 'pin_red', Blockly.Python.ORDER_NONE);
   var pin_green = Blockly.Python.valueToCode(block, 'pin_green', Blockly.Python.ORDER_NONE);
   var pin_blue = Blockly.Python.valueToCode(block, 'pin_blue', Blockly.Python.ORDER_NONE);
 ...
 Blockly.Python['socialrobot_rgb_color'] = function(block){
 ...
 Blockly.Python['socialrobot_rgb_color_with_numbers'] = function(block){
   var redComponent = Blockly.Python.valueToCode(block, 'RED', Blockly.Python.ORDER_NONE);
   var greenComponent = Blockly.Python.valueToCode(block, 'GREEN', Blockly.Python.ORDER_NONE);
   var blueComponent = Blockly.Python.valueToCode(block, 'BLUE', Blockly.Python.ORDER_NONE);
 
   var code = '[' + redComponent + ',' + greenComponent + ',' + blueComponent + ']';
   return code;
 };
 
 Blockly.Python['socialrobot_show_ledmatrix_image'] = function(block) {
 ...
 Blockly.Python['socialrobot_show_ledmatrix_eye_pattern'] = function(block) {
   let segment = block.getFieldValue('NUMBERDISPLAY');
 ...
 Blockly.Python['socialrobot_clear_ledmatrix_segment'] = function(block) {
   let segment = block.getFieldValue('NUMBERDISPLAY');
 ...
 Blockly.Python['socialrobot_clear_ledmatrix'] = function(block) {
   let code = machine + 'clearLedmatrixDisplay()\n';
   return code;
 }
 
 Blockly.Python['socialrobot_servo'] = function (block) {
 ...
 Blockly.Python['socialrobot_arms_down'] = function(block) {
   var value_servo_right_hand = Blockly.Python.valueToCode(block, 'servo_right_hand1', Blockly.Python.ORDER_ATOMIC);
   var value_servo_left_hand = Blockly.Python.valueToCode(block, 'servo_left_hand1', Blockly.Python.ORDER_ATOMIC);
 ...
 Blockly.Python['socialrobot_arms_up'] = function(block) {
   var value_servo_right_hand = Blockly.Python.valueToCode(block, 'servo_right_hand2', Blockly.Python.ORDER_ATOMIC);
   var value_servo_left_hand = Blockly.Python.valueToCode(block, 'servo_left_hand2', Blockly.Python.ORDER_ATOMIC);
 ...
 Blockly.Python['socialrobot_wave_arms'] = function(block) {
   var value_servo_right_hand = Blockly.Python.valueToCode(block, 'servo_right_hand', Blockly.Python.ORDER_ATOMIC);
   var value_servo_left_hand = Blockly.Python.valueToCode(block, 'servo_left_hand', Blockly.Python.ORDER_ATOMIC);
 ...
 Blockly.Python['socialrobot_eyes_left'] = function(block) {
   var value_servo_right_eye = Blockly.Python.valueToCode(block, 'servo_right_eye', Blockly.Python.ORDER_ATOMIC);
   var value_servo_left_eye = Blockly.Python.valueToCode(block, 'servo_left_eye', Blockly.Python.ORDER_ATOMIC);
 ...
 Blockly.Python['socialrobot_eyes_right'] = function(block) {
   var value_servo_right_eye = Blockly.Python.valueToCode(block, 'servo_right_eye1', Blockly.Python.ORDER_ATOMIC);
   var value_servo_left_eye = Blockly.Python.valueToCode(block, 'servo_left_eye1', Blockly.Python.ORDER_ATOMIC);
 ...
 Blockly.Python['socialrobot_set_pin'] = function(block){
   var pin_number = Blockly.Python.valueToCode(block, "PIN", Blockly.Python.ORDER_ATOMIC);
   var pin_state = Blockly.Python.valueToCode(block, "PIN_STATE", Blockly.Python.ORDER_ATOMIC);
