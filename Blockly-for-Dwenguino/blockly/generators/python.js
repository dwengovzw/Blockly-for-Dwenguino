 ...
 */
 ...
 Blockly.Python.ORDER_ASSIGNMENT = 15;
 Blockly.Python.ORDER_CONDITIONAL = 16;      // if else
 Blockly.Python.ORDER_LAMBDA = 17;           // lambda
 ...
 Blockly.Python.init = function(workspace) {
   ...
   Blockly.Python.workspace = workspace;
 ...
 Blockly.Python.finish = function(code) {
   ...
   var setups = Blockly.Python.setups_;
   ...
   var joinedSetups = setups.join("\n\t");
   var setupStatements = "\t" + joinedSetups;
   if (joinedSetups.trim() == ""){
     setupStatements = "\tpass"
   }
   if (code == ""){
     code = "\tpass"
   }
 
   var setupCode = 'def setup():\n' + setupStatements
   var loopCode = 'def loop():\n' + code
   code = setupCode + '\n\n' + loopCode
