...
let SerialMonitor = class SerialMonitor extends lit__WEBPACK_IMPORTED_MODULE_0__.LitElement {
    ...
    render() {
        return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html) `
            ...
            ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html) `<monitor-output lines=${this.output}></monitor-output>`
            : (0,lit__WEBPACK_IMPORTED_MODULE_0__.html) `<line-chart-wrapper chartData=${JSON.stringify(JSON.parse(this.output).map((item) => Number(item)).slice(0, -1))}></line-chart-wrapper>`}
