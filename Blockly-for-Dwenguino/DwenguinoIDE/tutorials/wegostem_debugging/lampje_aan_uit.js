...
tutorials.lampOnOffWeGoSTEM = {
      ...
      initSteps: function(){
        ...
        for (i = 0 ; i < this.nrOfSteps ; i++){
          this.steps.push({
            title: MSG.tutorials.lampOnOffWeGoSTEM.stepTitles[i],
            content: MSG.tutorials.lampOnOffWeGoSTEM.stepContents[i],
