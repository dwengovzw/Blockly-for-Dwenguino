var MSG = {
  ...
  angle: "angle",
  speed: "vitesse",
  dwenguinoServoBlock: "Servomoteur",
  ...
  dwenguinoDCMotorBlock: "DC moteur",
  ...
  dwenguinoAnalogWriteBlock: "Écris sur",
  dwenguinoAnalogValue: "valeur analogiques",
  dwenguinoAnalogWriteTooltip: "Write an analog value between 0 and 255 to the specified pin",
  dwenguinoAnalogReadBlock: "Lire la valeur analogique de",
  ...
  socialrobotServoBlock: "Servomoteur",
  socialrobotWaveArmesBlock: "Saluez avec les mains",
  socialRobotArmsDownBlock: "Baissez les mains",
  socialRobotArmsUpBlock: "Levez les mains",
  socialRobotEyesLeftBlock: "Tournez les yeux à gauche",
  socialRobotEyesRightBlock: "Tournez les yeux à droit",
  socialRobotServoRightHand: "Servo main droite",
  socialRobotServoLeftHand: "Servo oeil droit",
  socialRobotServoRightEye: "Servo oeil gauche",
