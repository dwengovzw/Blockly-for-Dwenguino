...
MSG.simulator = {
  ...
  light: "Lichtsensor",
  led: "Led",
  ledDescription: "A light-emitting diode (LED) is a semiconductor device that emits light when an electric current passes through it. Different semiconductor materials produce different colors of light. ",
  lcd: "Lcd-scherm",
  lcdDescription: "The LCD display on the Dwengo board is a 16x2 character display with backlight.",
  decoration: "Decoratie",
  buzzer: "Buzzer",
  buzzerDescription: "The buzzer on the Dwengo board can be used to play a series of tones or short sound fragments. The height of each tone is controlled by defining the frequency of the buzzer. Use a delay block to change the length of a tone.",
  button: "Knop",
};
