...
var MSG = {
  ...
  dwenguinoAnalogWriteBlock: "schrijf naar",
  dwenguinoAnalogValue: "de analoge waarde",
  dwenguinoAnalogWriteTooltip: "Schrijf een analoge waarde tussen 0 en 255 naar de opgegeven pin",
  dwenguinoAnalogReadBlock: "lees analoge waarde van",
  ...
  next: "Volgende",
  previous: "Vorige",
  socialrobotPirBlock: "nabijheidssensor",
  socialrobotSetPinBlock: "zet",
  socialrobotReadPinBlock: "lees de waarde pin",
  socialrobotServoBlock: "servomotor",
  socialrobotWaveArmesBlock: "zwaai armen",
  socialRobotArmsUpBlock: "doe armen naar boven",
  socialRobotArmsDownBlock: "doe armen naar beneden",
  socialRobotEyesLeftBlock: "draai ogen naar links",
  socialRobotEyesRightBlock: "draai ogen naar rechts",
  socialRobotServoRightHand: "servo pin rechterhand",
  socialRobotServoLeftHand: "servo pin linkerhand",
  socialRobotServoRightEye: "Servo pin rechteroog",
  socialRobotServoLeftEye: "Servo pin linkeroog", 
...
MSG.simulator = {
  ...
  servo: "Servo",
  servoDescription: "A servo motor is an actuator that can rotate an object over a certain angle. In the simulator servo motors can be put at an angle between 0 and 180 degrees. Servo motors can easily be decorated and are thus ideal to make periodically moving components",
  motor: "Motor",
  scope: "Waarden",
  ...
  sonar: "Sonarsensor",
  sonarDescription: "Gebruik deze sensor om een persoon of object te detecteren en om te bepalen hoe ver van de sensor de persoon of het object zich bevindt. In de simulator is een schuifbalk voorzien om dit te simuleren. De sensor geeft de afstand terug in centimeter.",
  sound: "Geluidssensor",
  soundDescription: "Gebruik deze sensor om geluid te detecteren. In de simulator is een schuifbalk voorzien om geluid te simuleren. Bij geluid geeft de sensor 1 terug, bij stilte 0.",
  light: "Lichtsensor",
