...
class SocialRobotButton extends RobotComponent{
    constructor(eventBus, id, pin, state, visible, width, height, offsetLeft, offsetTop, htmlClasses){
        ...
        this._canvasId = 'sim_button_canvas' + this._id;
        this._button = null;
    ...
    toggleVisibility(visible){
        if (visible) {
            $('#sim_button' + this.getId()).css('visibility', 'visible');
        } else {
            $('#sim_button' + this.getId()).css('visibility', 'hidden');
        }
    }
