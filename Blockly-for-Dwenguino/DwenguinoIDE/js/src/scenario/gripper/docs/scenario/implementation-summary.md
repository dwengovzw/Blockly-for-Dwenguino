...
1. **constraints-overview.md** (constraint solver overview)
...
2. **constraints-documentation.md** (detailed constraint reference)
...
3. **quick-reference.md** (constraint solver quick lookup)
...
4. **kinematics-descriptor-guide.md** (descriptor structure reference)
   - Descriptor fields and schema details
   - Reference geometry guidance
   - Solver configuration notes

### 5. Example Descriptor File

**File**: `examples/example_descriptor_with_reference_points.json`
...
### Created Files (Current Relevant Set)
1. **constraints-documentation.md** - Full constraint documentation
2. **constraints-overview.md** - System overview
3. **quick-reference.md** - Quick lookup
4. **kinematics-descriptor-guide.md** - Descriptor reference
5. **examples/example_descriptor_with_reference_points.json** - Template
...
3. **Create JSON Descriptor**
   - Copy template from `examples/example_descriptor_with_reference_points.json`
