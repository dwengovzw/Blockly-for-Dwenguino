...
├── docs/constraint-solver/README_CONSTRAINTS.md       (overview)
├── docs/constraint-solver/CONSTRAINTS_DOCUMENTATION.md (detailed guide)
├── docs/constraint-solver/QUICK_REFERENCE.md          (this file)
