...
Blockly.Toolbox.prototype.init = function() {
  ...
  this.HtmlDiv.setAttribute('id', "db_blocklyToolboxDiv");
  ...
  for (var i = 0, childIn; childIn = treeIn.childNodes[i]; i++) {
    ...
    switch (childIn.tagName.toUpperCase()) {
      case 'CATEGORY':
        ...
        //Copy the id of the input child to the output child (Custom code for dwenguinoblockly)
        childOut.setId("db_" + childIn.getAttribute("id"));
        childOut.blocks = [];
