import DwenguinoSimulationScenario from '../../Blockly-for-Dwenguino/DwenguinoIDE/js/src/scenario/dwenguino_simulation_scenario.js'

class RandomSimulationEnvironment extends DwenguinoSimulationScenario{
    tick = 0;
    constructor(){
