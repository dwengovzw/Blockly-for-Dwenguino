...
//let prefix = "."; // This is only required for debugging default should be .
    ...
    handleExternalCommandOld(command: any, res: any, err_msg: string, succes_msg:string){
 ...
 */
    ...
    this.handleExternalCommand("cp -R " + command_location + "/hardware " + command_location +  "/sketch-" + objid + "/ && cp " + command_location + "/Makefile " + command_location +  "/sketch-" + objid + "/", (error, stderr)=>{
        ...
        this.handleExternalCommand(make_command + ' -C ' + command_location +  "/sketch-" + objid + " OBJDIR=" + objdir + ' clean', 
        (error, stderr) => {
            ...
            this.handleExternalCommand(make_command + ' -C ' + command_location +  "/sketch-" + objid + " OBJDIR=" + objdir, 
            (error, stderr) => {
                ...
                this.handleExternalCommand(sign_command + " " + signature_file + " " + file_to_sign + " " + binary_file + " " + tmp_file, 
                (error, stderr) => {
    ...
    this.handleExternalCommand("rm -Rf " + this.prefix + "/compilation/sketch-" + objid, 
                        (error, stderr)=>{
